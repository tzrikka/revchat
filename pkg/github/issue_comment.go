...
func (c Config) issueCommentCreated(ctx workflow.Context) error {
	logger.From(ctx).Warn("GitHub issue comment created - event handler not implemented yet")
	return nil
}

// A comment on an issue or pull request was edited.
func (c Config) issueCommentEdited(ctx workflow.Context) error {
	logger.From(ctx).Warn("GitHub issue comment edited - event handler not implemented yet")
	return nil
}

// A comment on an issue or pull request was deleted.
func (c Config) issueCommentDeleted(ctx workflow.Context) error {
	logger.From(ctx).Warn("GitHub issue comment deleted - event handler not implemented yet")
	return nil
}
